...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text"></i>邮箱模板</h3>
            <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="/Admin">首页</a></li>
                <li><i class="fa fa-credit-card"></i>邮箱模板</li>
            </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-indent red"></i><strong>邮箱模板</strong></h2>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="addMailboxTmpForm">
                        <div class="form-group"></div>

                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">邮件标题</label>
                            ...
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <script id="editor" type="text/plain" style="width:800px;height:300px;" name="content"><?php echo ($data["content"]); ?></script>

                                        <script type="text/javascript" charset="utf-8" src="/Public/plugins/ueditor1_4_3_2/ueditor.config.js"></script>
                                        <script type="text/javascript" charset="utf-8" src="/Public/plugins/ueditor1_4_3_2/ueditor.all.min.js"></script>
                                        <script type="text/javascript" charset="utf-8" src="/Public/plugins/ueditor1_4_3_2/lang/zh-cn/zh-cn.js"></script>
