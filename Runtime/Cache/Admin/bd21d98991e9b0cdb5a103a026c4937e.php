...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-github-alt"></i>管理员列表</h3>
            <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="/Admin">首页</a></li>
                <li><i class="fa fa-github-alt"></i>管理员列表</li>
            </ol>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2><i class="fa fa-th red"></i><strong>管理员列表</strong></h2>
        </div>
        <div class="panel-body">
            <a href="<?php echo U('Auth/admin_user',array('t'=>1));?>"><button type="button" class="btn btn-danger btn-xs">添加管理员</button></a>
        </div>
    </div>
    <!--其他区域 END-->
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if($data['list']): ?><tbody>
                            <?php if(is_array($data["list"])): foreach($data["list"] as $key=>$v): ?><tr class="cp-del-categorg">
                                    ...
                                    <td>
                                        <a class="btn btn-info Noline" href="<?php echo U('Auth/admin_user',array('t'=>1,'uid'=>$v['uid']));?>" title="修改">
