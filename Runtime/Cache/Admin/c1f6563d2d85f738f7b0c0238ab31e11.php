...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text"></i>修改密码</h3>
            <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="/Admin">首页</a></li>
                <li><i class="fa  fa-align-left"></i>修改密码</li>
            </ol>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="editPasswordForm">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">原密码</label>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">新密码</label>
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">确认新密码</label>
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
