...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-sitemap"></i>权限管理列表</h3>
            <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="/Admin">首页</a></li>
                <li><i class="fa fa-sitemap"></i>权限管理列表</li>
            </ol>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2><i class="fa fa-th red"></i><strong>权限管理列表</strong></h2>
        </div>
        <div class="panel-body">
            <a href="<?php echo U('Auth/rule',array('t'=>1));?>"><button type="button" class="btn btn-danger btn-xs">添加权限</button></a>
        </div>
    </div>
    <!--其他区域 END-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-table red"></i><span class="break"></span><strong>权限管理列表</strong></h2>
                ...
                <div class="panel-body">
                    <table class="table table-condensed">
                        ...
                        <?php if($data): ?><tbody>
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="cp-del-categorg">
                                    <td><?php echo ($v['_name']); ?></td>
                                    <td><?php echo ($v['name']); ?></td>
                                    <td>
                                        <?php if(!$v['pid']): ?><a class="btn btn-success Noline" href="<?php echo U('Auth/rule',array('t'=>1,'id'=>$v['id']));?>" title="添加子权限">
                                            <i class="fa fa-plus-square"></i>
                                        </a><?php endif; ?>
                                        <a class="btn btn-info Noline" href="<?php echo U('Auth/editRule',array('id'=>$v['id']));?>" title="修改">
                                            <i class="fa fa-edit "></i>
                                        </a>
                                        <?php if($v['pid']): ?><a class="btn btn-danger cp-del-data Noline" href="javascript:;" title="删除" markId="<?php echo ($v['id']); ?>" url="/Admin/Auth/ajaxdelRule">
                                            <i class="fa fa-trash-o"></i>
                                        </a><?php endif; ?>
                                    </td>
