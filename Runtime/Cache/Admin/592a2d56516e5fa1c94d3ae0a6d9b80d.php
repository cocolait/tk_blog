...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-envelope"></i>SMTP邮箱配置</h3>
            <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="/Admin">首页</a></li>
                <li><i class="fa fa-envelope"></i>SMTP邮箱配置</li>
            </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-indent red"></i><strong>SMTP邮箱配置</strong></h2>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="mailboxForm">

                        <div class="form-group" style="margin-top: 14px;">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">发件人</label>
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                        <input type="text" class="form-control" name="sender" value="<?php echo ($data['CP_EMAIL_FROM_NAME']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">SMTP服务器</label>
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                        <input type="text" class="form-control" name="smtp" value="<?php echo ($data['CP_EMAIL_SMTP']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">发件箱帐号</label>
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                        <input type="text" class="form-control" name="loginname" value="<?php echo ($data['CP_EMAIL_USERNAME']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">发件箱授权密码</label>
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                        <input type="password" class="form-control" name="password" value="<?php echo ($data['CP_EMAIL_PASSWORD']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
