...
return array(
    //腾讯QQ登录配置
    'THINK_SDK_QQ'      => array(
        'APP_KEY'       => C('QQ_APP_KEY'), //应用注册成功后分配的 APP ID
        'APP_SECRET'    => C('QQ_APP_SECRET'), //应用注册成功后分配的KEY
        'CALLBACK'      => C('QQ_CALLBACK'),
    ),
    //腾讯微博配置
    ...
    'THINK_SDK_SINA'    => array(
        'APP_KEY'       => C('SINA_APP_KEY'), //应用注册成功后分配的 APP ID
        'APP_SECRET'    => C('SINA_APP_SECRET'),//应用注册成功后分配的KEY
        'CALLBACK'      => C('SINA_CALLBACK'),
    ),
    //网易微博配置
